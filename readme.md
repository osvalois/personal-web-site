...
We recommend duplicating the [default page](https://notion.so/Trend-weekly-853344eb5e544864b3bd89bb4710f66a) as a starting point, but you can use any public notion page you want.

Make sure your root Notion page is **public** and then copy the link to your clipboard. Extract the last part of the URL that looks like `Trend-weekly-853344eb5e544864b3bd89bb4710f66a`, which is your page's Notion ID.
...
MIT © [Oscar Valois](https://transitivebullsh.it)
